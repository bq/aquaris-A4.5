...
#ifndef accdet_earphone_pinread//lc  mike_zhu 20151112 for  earphone pop noise becaue of gpio on off plus
//LC--qindh--20151108 add for  headset start
#include <linux/of_gpio.h>
#include <linux/gpio.h>
#include <asm-generic/gpio.h>
//LC--qindh--20151108 add for  headset end 
#else
...
#ifdef CONFIG_MTK_SPEAKER
static int Speaker_mode = AUDIO_SPEAKER_MODE_D;//////lc mike_zhu 20141207 for speaker  AUDIO_SPEAKER_MODE_AB;
...
static int Audio_AmpL_Set(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
	...
	if ((ucontrol->value.integer.value[0] == true)
		...
		mCodec_data->mAudio_Ana_DevicePower[AUDIO_ANALOG_DEVICE_OUT_HEADSETL] =
		    ucontrol->value.integer.value[0];
#ifndef accdet_earphone_pinread//lc  mike_zhu 20151112 for  earphone
//LC--qindh--20151108 add for  headset start
		{
			int ampl_gpio;
...
//LC--qindh--20151108 add for  headset end 
	...
	gpio_direction_output(accdet_gpio_44_pin, 1);
		   ...
		   && (mCodec_data->mAudio_Ana_DevicePower[AUDIO_ANALOG_DEVICE_OUT_HEADSETL] ==
		       true)) {
#ifdef accdet_earphone_pinread//lc  mike_zhu 20151112 for  earphone
		temp_value=accdet_get_readID_pin();
