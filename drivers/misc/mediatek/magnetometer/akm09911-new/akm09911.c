...
//#define POWER_NONE_MACRO MT65XX_POWER_NONE  //swf delete
...
//static struct i2c_board_info __initdata i2c_akm09911={ I2C_BOARD_INFO("akm09911", 0x0D)};    //swf delete
...
#endif
#ifdef   LC_DEVINFO_MSENSOR
	msensor_devinfo_init(); //swf add for devinfo
#endif
	MAG_ERR("%s: OK\n", __func__);
	LCSH_DEBUG("okokokok .\n");
