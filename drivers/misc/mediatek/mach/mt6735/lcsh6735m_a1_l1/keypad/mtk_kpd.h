...
#define ONEKEY_REBOOT_NORMAL_MODE  //zbl modify for press powerkey 15 reset system
//#define TWOKEY_REBOOT_NORMAL_MODE
#define ONEKEY_REBOOT_OTHER_MODE  //zbl modify for press powerkey 15 reset system
