...
int bq24261_reg_config_interface (unsigned char RegNum, unsigned char val)
{   
    int ret = 0;
...
void bq24261_set_tmr_rst(int val)
{
    int ret=0;    
...
void bq24261_set_en_boost(int val)
{
    int ret=0;    
...
void bq24261_set_en_shipmode(int val)
{
    int ret=0;    
...
void bq24261_set_reset(int val)
{
    int ret=0;    
...
void bq24261_set_in_limit(int val)
{
    int ret=0;    
...
void bq24261_set_en_stat(int val)
{
    int ret=0;    
...
void bq24261_set_dis_ce(int val)
{
    int ret=0;    
...
void bq24261_set_hz_mode(int val)
{
    int ret=0;    
...
void bq24261_set_vbreg(int val)
{
    int ret=0;    
...
void bq24261_set_mod_freq(int val)
{
    int ret=0;    
...
int bq24261_get_vender_code(void)
{
    int ret=0;
    unsigned char val=0;
...
void bq24261_set_iterm(int val)
{
    int ret=0;    
...
int bq24261_get_minsys_status(void)
{
    int ret=0;
    unsigned char val=0;
...
int bq24261_get_vindpm_status(void)
{
    int ret=0;
    unsigned char val=0;
...
void bq24261_set_low_chg(int val)
{
    int ret=0;    
...
void bq24261_set_dpdm_en(int val)
{
    int ret=0;    
...
int bq24261_get_cd_status(void)
{
    int ret=0;
    unsigned char val=0;
...
void bq24261_set_vindpm(int val)
{
    int ret=0;    
...
void bq24261_set_2xtmr_en(int val)
{
    int ret=0;    
...
void bq24261_set_boost_ilim(int val)
{
    int ret=0;    
...
void bq24261_set_ts_en(int val)
{
    int ret=0;    
...
void bq24261_set_vindpm_off(int val)
{
    int ret=0;    
