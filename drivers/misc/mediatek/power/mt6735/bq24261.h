...
/**********************************************************
  ...
  *********************************************************/
//CON0----------------------------------------------------
extern void bq24261_set_tmr_rst(int val);
extern void bq24261_set_en_boost(int val);
extern int bq24261_get_stat(void);
extern void bq24261_set_en_shipmode(int val);
extern int bq24261_get_fault(void);
//CON1----------------------------------------------------
extern void bq24261_set_reset(int val);
extern void bq24261_set_in_limit(int val);
extern void bq24261_set_en_stat(int val);
extern void bq24261_set_te(int val);
extern void bq24261_set_dis_ce(int val);
extern void bq24261_set_hz_mode(int val);
//CON2----------------------------------------------------
extern void bq24261_set_vbreg(int val);
extern void bq24261_set_mod_freq(int val);
//CON3----------------------------------------------------
extern int bq24261_get_vender_code(void);
extern int bq24261_get_pn(void);
//CON4----------------------------------------------------
extern void bq24261_set_ichg(int val);
extern void bq24261_set_iterm(int val);
//CON5----------------------------------------------------
extern int bq24261_get_minsys_status(void);
extern int bq24261_get_vindpm_status(void);
extern void bq24261_set_low_chg(int val);
extern void bq24261_set_dpdm_en(int val);
extern int bq24261_get_cd_status(void);
extern void bq24261_set_vindpm(int val);
//CON6----------------------------------------------------
extern void bq24261_set_2xtmr_en(int val);
extern void bq24261_set_tmr(int val);
extern void bq24261_set_boost_ilim(int val);
extern void bq24261_set_ts_en(int val);
extern  int bq24261_get_ts_fault(void);
extern void bq24261_set_vindpm_off(int val);

//---------------------------------------------------------
extern void bq24261_dump_register(void);
extern int bq24261_reg_config_interface (unsigned char RegNum, unsigned char val);

extern int bq24261_read_interface (unsigned char RegNum, unsigned char *val, unsigned char MASK, unsigned char SHIFT);
extern int bq24261_config_interface (unsigned char RegNum, unsigned char val, unsigned char MASK, unsigned char SHIFT);
