...
/*
    ...
    {0x00,1,	{0x00}},                                                                                                                                                                     
    {0xD8,2,	{0x67,0x67}},// GVDD=5.2V, NGVDD=-5.2V                                                                                                                       
    {0x35,1,{0}},
    {0x11,0,{}},
    {REGFLAG_DELAY, 120, {}},
    {0x29,0,{}},
...
{0xC0,2,{0x00,0x50}},
{0x00,1,{0x81}},
{0xC1,1,{0x55}}, // change fps 55 66 77
...
//lc zgy 20151105 modify lcm dev_info
   ...
   //  printk("zgy...gpio value: %s\n",params->vendor);
	...
	//modify by zwp to support esd check
...
{
    //lc zgy 20151105 modify lcm compatible
	int temp_id;
...
static void lcm_suspend(void)
{
	...
	dsi_set_cmdq(data_array, 1, 1);
	//MDELAY(100);//LC--zbl--rm-for reduce suspend time 20150504
