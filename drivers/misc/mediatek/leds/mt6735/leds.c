...
//LC--qindh--20151029-add for bread led start
...
//LC--zbl--20151029-add for bread led end
...
int mt_mt65xx_led_set_cust(struct cust_mt65xx_led *cust, int level)
{
	...
	case MT65XX_LED_MODE_CUST_BLS_PWM:
		...
		/*LC--qindh--add--start--20151029  for auto brightness minimum level diff to manual level */
                if((level<40) && (level>5))
                {
                        level = 40;
                }
                /*2015.10.29 qindh add for RGB driver end*/

		/*2015.10.29 qindh add for RGB driver start*/
		...
		if (led_data->delay_on && led_data->delay_off) {	/* enable blink */
			...
			if (led_data->cust.mode == MT65XX_LED_MODE_PWM) {
				...
				return 0;
                        ...
                        /*2015.11.27 qindh add for RGB driver start*/
                        ...
                        /*2015.11.27 qindh add for RGB driver end*/
			...
			if (led_data->cust.mode == MT65XX_LED_MODE_PWM) {
				...
				return 0;
                        ...
                        {
				/*LC--2015.11.27--qindh add for RGB driver start*/
				    if((strcmp(led_cdev->name, "red") == 0) || (strcmp(led_cdev->name, "blue") == 0)
				       ||(strcmp(led_cdev->name, "green") == 0))
				{
				...
				/*LC--2015.11.27--qindh add for RGB driver end*/
                        }
