...
#endif
//LC--qindh--add-20151101-for precc start
...
//LC--qindh--add-20151101-for precc end
...
#if !defined(CONFIG_MTK_JEITA_STANDARD_SUPPORT)
			if (batt_cust_data.high_battery_voltage_support)
				cv_voltage = BATTERY_VOLT_04_420000_V;  //LC--qindh--2015-11-11--modify--for charging 4.42v high battery voltage
			else
				cv_voltage = BATTERY_VOLT_04_200000_V;
