...
//lc zgy 20151117 add for proximity sensor is covered when double tap    
...
//lc zgy 20151116 add add vibrator when tp doubel click
		//vibr_Enable_HW();
...
static int mxt_proc_message(struct mxt_data *data, u8 *message)
{
	...
	/*swf 20150707 delete because of L8452 have not virtual key */
...
//lc zgy 20151114 modify for test
...
#if defined(CONFIG_ESD_CHECK_A_REGISTER)
static  void write_data_to_read(struct mxt_data *data)  //swfesd
{
